...
public class ShoppingPage extends BasePage {
    ...
    @FindBy(how = How.CSS, using = ".show h3")
            WebElement cartItem;
    ...
    public void clickingWomensTopButton() {womensTopsButton.click();}
    ...
    public void clickingKidsButton() {kidsButton.click();}
    ...
    public void clickingGirlsButton(){girlsButton.click();}
    ...
    public void clickingPriceBarButton() {minPriceValue.clear();}
    public void enteringMaxValueInMinVal() throws InterruptedException {minPriceValue.sendKeys("80");
    maxPriceValue.clear();maxPriceValue.sendKeys("70"); cookieAccept.click();
        Thread.sleep(2000);
    ...
    public void clickingRedButton() {redButton.click();
        Actions builder = new Actions(driver);
        builder.moveToElement(applyButton).click();
    }
    ...
    public void findingMensOption() {mensAccessories.getText();
    String MensItemsCheck = mensAccessories.getText();
    Assert.assertEquals("Men's Accessories", MensItemsCheck.trim());
    }
    public void clickingMensJeansOption() {mensJeans.click();}
    ...
    public void clickingMensShoesOption() {mensShoes.click();}
    ...
    public void clickingWomensAccessoriesOption() {womensAccessories.click();}
    ...
    public void clickingWomensBottomsOption() {womensBottoms.click();}
    ...
    public void clickingKidsBoysOption(){kidsBoysButton.click();}
    ...
    public void addingToCart() {addToCart.click();}
    public void checkingCartList() {
        cartButton.click();
        String CartItemCheck = cartItem.getText();
        Assert.assertEquals("Straight Long Coat", CartItemCheck);
    }
